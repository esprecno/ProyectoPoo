...
public class MenuOpciones {
    ...
    public static void MenuInicializador(){
        ...
        switch (x) {
            case 1: {
                ...
                ArrayList<Tour> tours = GestionTours.listadoTours();
                for (Tour not : tours) {
            ...
            case 5: {
                int xx=1;
                 ArrayList<Cliente> clientes=GestionCliente.listadoclientes();
            ...
            case 6: {
                ...
                if(GestionCliente.insertarCliente(id, name, telefono)==true){
            ...
            case 8: {
                ...
                long id = sc.nextLong();
                System.out.println("Digite el numeral del dato que desea cambiar\n1.)Numero de identificacion: " + GestionCliente.buscarCliente(id).getNumeroIdentificacion()
                        + "\n2.)Nombre: " + GestionCliente.buscarCliente(id).getNombreCompleto() + "\n3.)Numero de telefono: " + GestionCliente.buscarCliente(id).getTelefonoContacto() + "\nSu opcion: ");
                int opcion;
                opcion = sc.nextInt();
                if (GestionCliente.buscarCliente(id) != null) {
                    switch (opcion) {
                        case 1:
                            ...
                            if (GestionCliente.modificarCliente(id, nuevoId)) {
                        ...
                        case 2:
                            ...
                            GestionCliente.modificarCliente(id, nuevoNombre);
                        ...
                        case 3:
                            ...
                            GestionCliente.modificarCliente(nuevoTelefono, id);
            ...
            case 9: {
                ...
                if ((GestionCliente.buscarCliente(idEliminar) != null) && (ControlAgencia.asociacionReservas(GestionCliente.buscarCliente(idEliminar)))) {
                    System.out.print("Realmente desea eliminar el cliente\n1.)Si\n2)No\nSu opcion: ");
                    int opcion = sc.nextInt();
                    while ((opcion != 2) || (opcion != 1)) {
                        switch (opcion) {
                            case 1:
                                GestionCliente.eliminarCliente(idEliminar, opcion);
            ...
            case 12: {
                int xx=1;
                ArrayList<Reserva> reservas=ControlAgencia.listadoResevas();
